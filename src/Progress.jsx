...
const ProgressPath = props => {
  const dashLength = 312;
  const dashOffset = dashLength * (100 - props.progress) / 100;
  ...
  return (
    <g transform="translate(0 -193)">
      ...
      stroke={props.color} strokeDasharray={dashLength} strokeDashoffset={dashOffset}
...
const Progress = props => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="-7.8 0 133 87"
    ...
    <ProgressPath color="#b9ceba" progress="100"/>
    <ProgressPath color="#4caf50" progress={props.progress}/>
  </svg>
);
